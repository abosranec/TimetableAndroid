...
public class RouteAdapter extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView busDays = viewLocal.findViewById(R.id.bus_regularity);
        ...
        if (i % 2 == 0) {
            ...
            busDays.setBackgroundColor(Color.argb(130, 220, 220, 220));
        } else{
            ...
            busDays.setBackgroundColor(Color.argb(0, 255, 255, 255));
        }
        return viewLocal;
    }
